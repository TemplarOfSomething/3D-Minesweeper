    ...
    for y in range(5):
        for x in range(5):
            if mine_dict[(x,y,z)] == '*':
                ...
                cubes[(x,y,z)] = Entity(model='cube', collider='box', texture='img/Tile-1', position=(x,y,z), scale=(1,1,1), on_click=clicking)
            elif mine_dict[(x,y,z)] == 2:
                cubes[(x,y,z)] = Entity(model='cube', collider='box', texture='img/Tile-2', position=(x,y,z), scale=(1,1,1), on_click=clicking)
            elif mine_dict[(x,y,z)] == 3:
                cubes[(x,y,z)] = Entity(model='cube', collider='box', texture='img/Tile-3', position=(x,y,z), scale=(1,1,1), on_click=clicking)
            elif mine_dict[(x,y,z)] == 4:
                cubes[(x,y,z)] = Entity(model='cube', collider='box', texture='img/Tile-4', position=(x,y,z), scale=(1,1,1), on_click=clicking)
                ...
                cubes[(x,y,z)] = Entity(model='cube', collider='box', texture='img/Tile-Blank', position=(x,y,z), scale=(1,1,1), on_click=clicking)
